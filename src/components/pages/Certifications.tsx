  ...
  const certifications = [
    {
      ...
      description:
        "Earned Google's Prompting Essentials certification, strengthening skills in advanced prompting techniques, multimodal prompting, and reusable prompt design.",
    ...
    },
    {
      ...
      description:
        "Completed Vanderbilt Prompt Engineering Specialization covering reusable prompt design, LLM-based analysis, and responsible generative AI.",
      category: "Prompt Engineering",
    },
    {
      id: 3,
      ...
      description:
        "Earned Advanced Prompt Engineering certification focused on structured reasoning, prompt optimization, LangChain workflows, and RAG-based data generation.",
      category: "Prompt Engineering",
    },
    {
      id: 4,
      ...
      description:
        "Completed Kore.ai Automation AI Basic Training with hands-on skills in agent nodes, automation flows, LLM integrations, and building intelligent virtual assistants.",
    ...
    },
    {
      ...
      URL: "https://academy.kore.ai/",
      description:
        "Certified in Kore.ai Automation AI Advanced Training with hands-on expertise in advanced conversational flows, multilingual enablement, analytics, and secure LLM-powered automation.",
      category: "Conversational AI",
    },
    {
      id: 6,
      ...
      description:
        "Learned core Dialogflow CX design principles, building virtual agents with intents, entities, flows, and webhook integrations.",
      category: "Conversational AI",
    },
    {
      id: 7,
      ...
      URL: "https://academy.kore.ai/",
      description:
        "Completed Kore.ai XO basic training covering virtual assistant development, NLP configuration, and platform workflow fundamentals.",
      category: "Conversational AI",
    },
    {
      id: 8,
      ...
      description:
        "Certified in designing, building, and operationalizing secure, scalable data pipelines on Google Cloud for analytics and machine learning.",
          ...
          <div className="relative rounded-[32px] border border-white/60 bg-white/95 backdrop-blur-sm shadow-[0_35px_90px_rgba(13,59,102,0.12)] p-8 space-y-10">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                A snapshot of my ongoing learning and professional development
                across Conversational AI, Prompt Engineering, and Data
                Engineering.
              </p>
            </div>
                ...
                <div>
                  <div className="bg-purple-50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                    <span className="text-2xl font-bold text-purple-600">
                      {Object.keys(categorizedCerts).length}
                    </span>
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-1">
                    Categories
            ...
            <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-lg p-8">
              ...
              <p className="text-gray-700 mb-6 text-center max-w-3xl mx-auto">
                I regularly update my skills through professional certifications
                and training programs. Currently pursuing advanced certifications
                in emerging AI and data technologies.
              </p>
